...
Assignment: Download a set of pretrained vectors, GloVe, and explore them. #Data: download.file('<https://nlp.stanford.edu/data/glove.6B.zip>',destfile = 'glove.6B.zip') #unzip('glove.6B.zip') #Use this file: 'glove.6B.300d.txt'
