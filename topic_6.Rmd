...
#grab data here: https://github.com/MaRo406/EDS_231-text-sentiment/blob/main/dat/comments_df.csv
comments_df <- read_csv(here("dat", "comments_df.csv"))
```
...
json_lda <- LDAvis::createJSON(phi = beta, theta = theta,
                            vocab = vocab,
