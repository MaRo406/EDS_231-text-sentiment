...
Let's break it out and plot the contributions by particular sentiment categories
...
Pseudo code for Froelich et al plot: mean sentiment by day, summarize plot x = day, y = sentiment
...
## Assignment (Due 4/19 by 11:59 PM)
...
0.  Using the "IPCC" Nexis Uni data set from the class presentation and the pseudo code we discussed, recreate Figure 1A from Froelich et al. (Date x \# of 1) positive, 2) negative, 3) neutral headlines):
    ...
    ![Newspaper 'aquaculture' media sentiment. Sentiment over time based on the frequency of newspaper Fig. 1. Headlines with negative (red), positive (blue), and neutral (gray) titles](img/Froelich_Fig3A.png){width="386"}
